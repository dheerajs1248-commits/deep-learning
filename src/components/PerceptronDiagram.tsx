    ...
    <div className="diagram-container" id="perceptron-diagram-wrapper">
      ...
      <div className="svg-wrapper">
        ...
        >
          ...
          <line x1="80" y1="60" x2="250" y2="160" className="conn-pulse conn-pulse-1" />
          <line x1="80" y1="160" x2="250" y2="160" className="conn-pulse conn-pulse-2" />
          <line x1="80" y1="260" x2="250" y2="160" className="conn-pulse conn-pulse-3" />
          <line x1="250" y1="50" x2="250" y2="115" className="conn-pulse conn-pulse-bias" />
          <line x1="250" y1="160" x2="440" y2="160" className="conn-pulse conn-pulse-out" />
